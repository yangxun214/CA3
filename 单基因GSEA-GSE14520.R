...
library(patchwork)
setwd("E:/lab/GEO/GSE14520-os")
#输入文件
expFile = read.csv("exprSet_GPL3921-tumor-221.csv",header=TRUE,sep=",")
...
write.table(af,file=paste0("GSE14520_gseKEGG-CA3.xls"),sep="\t",quote=F,col.names=T)
