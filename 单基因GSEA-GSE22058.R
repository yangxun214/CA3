...
library(patchwork)
setwd("E:/lab/GEO/GSE22058/CA3-GSEA")
#输入文件
...
gseaplot2(Go_gseresult,627,color="red",pvalue_table = T)
...
write.table(af,file=paste0("GSE22058_gseKEGG-CA3.xls"),sep="\t",quote=F,col.names=T)
